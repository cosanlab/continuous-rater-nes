...
export const labName = 'CosanLab'; // name of lab running HIT experiment 
export const email = 'jonathan@twinbamboo.com'; // lab email for mturk
export const studyAim = 'track emotional variance across different media'; // aim of mturk study 
export const studyTasks = 'record variance of a specific emotion in a video'; // brief summary of HIT task for consent form
export const experiment = 'Emotion'; // name of experiment (should match collection name in firebase)
...
// stimuli variables      
export const ratingTypes = ['afraid', 'amused', 'angry', 'anxious', 'bored', 'disgusted', 'frusturated', 'happy', 'inspired', 'moved', 'proud', 'relieved', 'sad', 'surprised', 'uncomfortable', 'calm', 'hungry', 'awed', 'romantic']; // array of rating types   

// this configures path to proper firebase
// COPY AND PASTE YOUR FIREBASE CONFIG HERE
let firebaseConfig = {
     apiKey: "AIzaSyDuJK7KS7LynZZQ0CtZY5BYTcP7JW9rUOI",
     authDomain: "emotion-rating-system.firebaseapp.com",
     projectId: "emotion-rating-system",
     storageBucket: "emotion-rating-system.appspot.com",
     messagingSenderId: "709565333316",
     appId: "1:709565333316:web:e8e5610456c4d8015de111",
     measurementId: "G-EMRGK8DYVT"
    };
